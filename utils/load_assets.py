...
# Loading Ship Images
CIS_FIGHTER = pygame.image.load(os.path.join("assets/skins", "cis_fighter.png"))
...
# Player Ships
ARC_170 = pygame.image.load(os.path.join("assets/skins", "arc_170.png"))
ARC_170 = pygame.transform.scale(ARC_170, (150, 150))
LAAT = pygame.image.load(os.path.join("assets/skins", "laat.png"))
Y_WING = pygame.image.load(os.path.join("assets/skins", "y_wing.png"))
...
LASER_RED_MED = pygame.image.load(os.path.join("assets/lasers", "laser_red_med.png"))
LASER_BLUE_MED = pygame.image.load(os.path.join("assets/lasers", "laser_blue_med.png"))
